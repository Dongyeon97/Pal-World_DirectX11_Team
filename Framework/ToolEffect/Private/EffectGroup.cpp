...
std::shared_ptr<CEffectGroup> ToolEffect::CEffectGroup::Create(const std::shared_ptr<FGameObjectDesc>& _spGameObjectDesc)
{
...
std::shared_ptr<CEffectGroup> ToolEffect::CEffectGroup::CreateFromJson(const std::shared_ptr<FGameObjectDesc>& _spGameObjectDesc, const std::wstring& _wstrJsonFileName)
{
	shared_ptr<CEffectGroup> spInstance = make_shared<CEffectGroup>();
...
HRESULT ToolEffect::CEffectGroup::Initialize(const std::shared_ptr<FGameObjectDesc>& _spGameObjectDesc)
{
...
HRESULT ToolEffect::CEffectGroup::InitializeFromJson(const std::shared_ptr<FGameObjectDesc>& _spGameObjectDesc, const std::wstring& _wstrJsonFileName)
{
	if (FAILED(CGameObject::Initialize(_spGameObjectDesc))) { return E_FAIL; }
...
HRESULT ToolEffect::CEffectGroup::BeginPlay()
{
...
int32 ToolEffect::CEffectGroup::PreTick(float _fDeltaSeconds)
{
...
int32 ToolEffect::CEffectGroup::Tick(float _fDeltaSeconds)
{
...
int32 ToolEffect::CEffectGroup::PostTick(float _fDeltaSeconds)
{
...
HRESULT ToolEffect::CEffectGroup::EndPlay()
{
...
void ToolEffect::CEffectGroup::Release()
{
...
HRESULT ToolEffect::CEffectGroup::InitializeCollider(FColliderInfo _tColliderInfo)
{
...
HRESULT ToolEffect::CEffectGroup::LoadFromJsonFile(const std::wstring& _wstrJsonFileName)
{
	// 1. JSON문서를 읽기 모드로 연다.
	...
	if (doc["Effects"].IsArray())
	{
		...
		for (; iter != doc["Effects"].End(); ++iter)
		{
			...
			case EEffectType::EFFECTMESH:
			{
				...
				// 이펙트 메시 객체 생성
				shared_ptr<CEffectMeshObject> spEffectObject = CEffectMeshObject::Create(make_shared<CEffectMeshObject::FEffectMeshObjectDesc>(tEffectMeshObjectDesc), tEffectMeshInfo);
			...
			case EEffectType::InstanceEffectMesh:
			{
				...
				// 이펙트 메시 객체 생성
				shared_ptr<CInstanceEffectMeshObject> spInstanceEffectMeshObject = CInstanceEffectMeshObject::Create(make_shared<CInstanceEffectMeshObject::FInstanceEffectMeshObjectDesc>(tInstanceEffectMeshObjectDesc), tInstanceEffectMeshEffectMeshInfo, tInstanceEffectMeshInfo);
...
FParticleInfo ToolEffect::CEffectGroup::MakeParticleInfoFromJson(rapidjson::Value& _Value)
{
...
FEffectMeshInfo ToolEffect::CEffectGroup::MakeEffectMeshInfoFromJson(rapidjson::Value& _Value)
{
...
FInstanceEffectMeshInfo ToolEffect::CEffectGroup::MakeInstanceEffectMeshInfoFromJson(rapidjson::Value& _Value)
{
...
HRESULT ToolEffect::CEffectGroup::AddEffect(const std::wstring& _wstrEffectName, std::shared_ptr<CEffectBase> _spEffect)
{
...
HRESULT ToolEffect::CEffectGroup::RemoveEffect(const std::wstring& _wstrEffectName)
{
	if (!m_mapEffects.contains(_wstrEffectName)) { return E_FAIL; }
...
std::shared_ptr<CEffectBase> ToolEffect::CEffectGroup::FindEffect(const std::wstring& _wstrEffectName)
{
...
void ToolEffect::CEffectGroup::AttachToBone()
{
...
void ToolEffect::CEffectGroup::UpdateColliderInfo(FColliderInfo _tColliderInfo)
{
...
void ToolEffect::CEffectGroup::RecycleFromPool()
{
	SetActive(true);
	SetCulled(false);
...
void ToolEffect::CEffectGroup::NoneActivate()
{
	SetActive(false);
	SetCulled(true);
...
void ToolEffect::CEffectGroup::EndLifeTime()
{
	SetActive(false);
	SetCulled(true);
...
void ToolEffect::CEffectGroup::Loop()
{
	SetActive(true);
	SetCulled(false);
	m_fTrackPosition = 0.f;
...
void ToolEffect::CEffectGroup::Reset()
{
	SetActive(true);
	SetCulled(false);
	m_fTrackPosition = 0.f;
