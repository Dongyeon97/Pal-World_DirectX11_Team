...
std::shared_ptr<CInstanceEffectMeshObject> ToolEffect::CInstanceEffectMeshObject::Create(const std::shared_ptr<FGameObjectDesc>& _spGameObjectDesc, FEffectMeshInfo _tEffectMeshInfo, FInstanceEffectMeshInfo _tInstanceEffectMeshInfo)
{
...
std::shared_ptr<CInstanceEffectMeshObject> ToolEffect::CInstanceEffectMeshObject::CreateFromJson(const std::shared_ptr<FGameObjectDesc>& _spGameObjectDesc, const std::wstring& _wstrJsonFileName)
{
	shared_ptr<CInstanceEffectMeshObject> spInstance = make_shared<CInstanceEffectMeshObject>();
	CHECKF(spInstance, L"CInstanceEffectMeshObject : Create Failed");
...
HRESULT ToolEffect::CInstanceEffectMeshObject::Initialize(const std::shared_ptr<FGameObjectDesc>& _spGameObjectDesc)
{
...
HRESULT ToolEffect::CInstanceEffectMeshObject::InitializeFromJson(const std::shared_ptr<FGameObjectDesc>& _spGameObjectDesc, const std::wstring& _wstrJsonFileName)
{
	if (FAILED(CEffectBase::Initialize(_spGameObjectDesc))) { return E_FAIL; }
...
HRESULT ToolEffect::CInstanceEffectMeshObject::BeginPlay()
{
...
int32 ToolEffect::CInstanceEffectMeshObject::PreTick(float _fDeltaSeconds)
{
...
int32 ToolEffect::CInstanceEffectMeshObject::Tick(float _fDeltaSeconds)
{
...
int32 ToolEffect::CInstanceEffectMeshObject::PostTick(float _fDeltaSeconds)
{
...
HRESULT ToolEffect::CInstanceEffectMeshObject::EndPlay()
{
...
void ToolEffect::CInstanceEffectMeshObject::Release()
{
	CEffectBase::Release();
}

uint32 ToolEffect::CInstanceEffectMeshObject::GetCurKeyFrameIndex()
{
	return m_spInstanceEffectMesh->GetCurKeyFrameIndex();
}

std::vector<FEffectMeshKeyFrame>& ToolEffect::CInstanceEffectMeshObject::GetKeyFrames()
{
